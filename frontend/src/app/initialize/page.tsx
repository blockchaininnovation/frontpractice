...
const INPUTS = [
  ...
  },
  {
    ...
    _type: "number",
    description:
      "(特に理由がなければ、デフォルトのままで問題ありません。) 投票の有効期限を入力してください。単位はブロック秒です。( 1 == 1 second )",
  },
  {
    ...
    _type: "number",
    description:
      "(特に理由がなければ、デフォルトのままで問題ありません。) 投票の集計間隔を入力してください。単位はブロック秒です。( 1 == 1 second )",
  },
  {
    ...
    _type: "number",
    description:
      "(特に理由がなければ、デフォルトのままで問題ありません。) Reps はある proposal に fork, vote 可能な DAO 参加者のサブセットです。人数を指定してください。",
  },
  {
